...
public class ApiV1PostController {
    ...
    @DeleteMapping("/{id}")
    public RsData<PostDto> deleteItem(@PathVariable("id") long id) {
    ...
    @PutMapping("/{id}")
    @Transactional
    public RsData<PostDto> modifyItem(@PathVariable("id") long id, @RequestBody @Valid PostModifyReqBody reqBody) {
